...
class CreatePostActivity : AppCompatActivity() {
    ...
    private val requestVideoPermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
        ...
        else Toast.makeText(this, "Camera and Audio permissions are required to record video", Toast.LENGTH_SHORT).show()
    }
    ...
    private val requestStoragePermissionLauncher = registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { permissions ->
        ...
        else Toast.makeText(this, "Photo access permission is required", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun showTopicSelectionDialog() {
        ...
        rvTopics.layoutManager = GridLayoutManager(this, 2)
    ...
    private fun previewMedia(uri: Uri) {
        ...
        try { startActivity(intent) } catch (e: Exception) { Toast.makeText(this, "No app found to open this file", Toast.LENGTH_SHORT).show() }
    }
